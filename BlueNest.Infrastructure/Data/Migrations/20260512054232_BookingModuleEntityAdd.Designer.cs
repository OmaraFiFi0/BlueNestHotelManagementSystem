...
namespace BlueNest.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260512054232_BookingModuleEntityAdd")]
    partial class BookingModuleEntityAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueNest.Core.Entities.SecurityModule.StaffUser", b =>
                {
                    b.HasBaseType("BlueNest.Core.Entities.SecurityModule.HotelUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlueNest.Core.Entities.SecurityModule.HotelUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BlueNest.Core.Entities.SecurityModule.StaffUser", b =>
                {
                    b.HasOne("BlueNest.Core.Entities.SecurityModule.HotelUser", null)
                        .WithOne()
                        .HasForeignKey("BlueNest.Core.Entities.SecurityModule.StaffUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
